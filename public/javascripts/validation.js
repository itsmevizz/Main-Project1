...
function submit() {
  if (!inp_editor1() || !validateProductName()) {
    return false
  } else {
    return true
  }
...
function validateOtp1() {
  otp1 = document.getElementById("first")
  if (otp1 == "") {
    return false
  } else {
    return true
...
function validateOtp2() {
  otp1 = document.getElementById("second").value
  if (otp1 === '') {
    return false
  } else {
    return true
...
function validateOtp3() {
  otp1 = document.getElementById("third").value
  if (otp1 === '') {
    return false
  } else {
    return true
...
function validateOtp4() {
  otp1 = document.getElementById("fourth").value
  if (otp1 === '') {
    return false
  } else {
    return true
...
function validateFullOtp() {
  if (!validateOtp1() || !validateOtp2() || !validateOtp3() || !validateOtp4()) {
    otpERROR.innerHTML = "Please Give Otp"
    setTimeout(()=>{
      otpERROR.innerHTML = ""
    },1000)
    return false;
